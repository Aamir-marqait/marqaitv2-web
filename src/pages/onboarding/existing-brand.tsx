...
export default function ExistingBrand() {
  ...
  const handleContinue = () => {
    // Save to context (reusing newBrand structure for existing brand basic info)
    setNewBrandData({
      businessName,
      industry: selectedIndustry,
    });
    navigate("/onboarding/existing-brand-details");
  };
